...
export default function TransferPage() {
  ...
  const handleConfirmTransfer = async () => {
    ...
    try {
      ...
      // Start a transaction (in a real app, use RPC or a transaction)
      ...
      const { error: transactionError } = await supabase
        ...
        .insert({
          ...
          recipient_name: 'Demo Recipient', // In real app, fetch from database
          status: 'completed',
        })

      if (transactionError) throw transactionError

      toast.success(`Successfully sent ${formatCurrency(transferData.amount)}`)
      reset()
        ...
        <AlertDialog open={showConfirm} onOpenChange={setShowConfirm}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                You are about to send {transferData && formatCurrency(transferData.amount)} to account {transferData?.recipientAccount}.
